...
namespace DbMigrations.Migrations
{
    ...
    [Migration("20250319184220_InitialMigration")]
            ...
            modelBuilder.Entity("Domain.Entities.Notification", b =>
                {
                    ...
                    b.HasIndex("NextNotificationExecutionId")
                        .IsUnique()
                        .HasDatabaseName("ix_notification_next_notification_execution_id");

                    b.HasIndex("NotificationMethodId")
                        .HasDatabaseName("ix_notification_notification_method_id");
            ...
            modelBuilder.Entity("Domain.Entities.NotificationExecution", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_notification_execution");

                    b.HasIndex("NotificationId")
                        .HasDatabaseName("ix_notification_execution_notification_id");

                    b.ToTable("notification_execution", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Notification", b =>
                {
                    b.HasOne("Domain.Entities.NotificationExecution", "NextNotificationExecution")
                        ...
                        .HasConstraintName("fk_notification_notification_execution_next_notification_execu");
                    ...
                    b.HasOne("Domain.Entities.NotificationMethod", "NotificationMethod")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_notification_notification_method_notification_method_id");
            ...
            modelBuilder.Entity("Domain.Entities.NotificationExecution", b =>
                {
                    b.HasOne("Domain.Entities.Notification", "Notification")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_notification_execution_notification_notification_id");
